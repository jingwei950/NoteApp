...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    ...
    /* TODO for using list of Note object with database, uncomment this*/
...
//        holder.noteTitle.setText(notes.get(position).getContent());   //Get the position and set the text of content in List with the same position
//        holder.noteCard.setCardBackgroundColor(holder.view.getResources().getColor(color));   //Set the card view with random color
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                /* TODO for using list of Note object with database, uncomment this*/
//                Intent noteIntent = new Intent(view.getContext(), NoteActivity.class);                //Pass the context and the activity
//                noteIntent.putExtra("title", notes.get(holder.getAdapterPosition()).getTitle());      //Pass the title to the new activity
//                noteIntent.putExtra("content", notes.get(holder.getAdapterPosition()).getContent());  //Pass the content to the new activity
//                noteIntent.putExtra("color", color);                                                  //Pass the color to the new activity
//                view.getContext().startActivity(noteIntent);                                          //Start the note activity
            }
        });
